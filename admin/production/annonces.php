                      ...
                      <tbody>
                        ...
                        ?></td>
                          ...
                          <td class="project_progress">
                            ...
                            <small>delais critique</small>
                          </td>
                          <td>
                            <button type="button" class="btn btn-danger btn-xs">A Envoyer</button>
                          </td>
                          <td>
                            <button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#candidateModal<?php echo $ligne['id_anno'] ;?>">candidater</button>
                          </td>
                          <td>
