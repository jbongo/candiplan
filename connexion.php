          ...
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                <div class="block">
                  <h1>Espace Membre</h1>
                  <p>Connecte toi à ton espace membre avec tes identifiants uniques</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="col-md-6 col-sm-12">
                <div class="block">
                  <form method="post" action="#">
                    ...
                    <p>Tu n'as pas de compte? <a href="inscription.php"> inscrit toi maintenant...</a></p>
                  </form>
                </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                ...
                <p>Copyright &copy; 2017 Crafted by <a href="https://dcrazed.com/">Dcrazed</a>.</p>
              </div>
            </div>
          </div>
        </footer>
